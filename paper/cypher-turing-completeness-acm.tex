...
\texttt{MATCH}, no extensions, no plugins. Turing-completeness resides
in the expression language alone.
\end{factbox}
...
[Anonymous]. 2025.
Solving Hard Graph Problems with the Graph Query Language Under Study.
