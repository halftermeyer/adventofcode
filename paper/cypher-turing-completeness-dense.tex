...
\begin{sfact}[Corollary 2: Practical implications]
Cypher can compute any computable function: game-tree search via
nested \texttt{reduce()} with alpha-beta pruning, Gaussian
elimination via list-of-lists, genetic algorithms via iterated
\texttt{reduce()} over populations, and any algorithm expressible
as a fold.
\end{sfact}

\begin{sfact}[Corollary 3: Beyond computability]
...
\bibitem{evblog}
Halftermeyer, P.\ (2025). Declarative Route Planning for EVs
With Neo4j --- Graph Traversal Grows Up.
\href{https://neo4j.com/blog/developer/declarative-route-planning-with-cypher-25/}{Neo4j Developer Blog}.
