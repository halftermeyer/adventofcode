...
\email{pierre.halftermeyer@neo4j.com}
\affiliation{%
  \institution{Neo4j}
  \country{France}
}
...
\begin{abstract}
We prove that Cypher~25, the graph query language of Neo4j, is
...
the simulation on a live Neo4j Aura instance.
\end{abstract}
...
\begin{claimbox}
Cypher~25, restricted to a single
...
\subsection{Resolution via \texttt{IN TRANSACTIONS}}
...
\smallskip
\noindent\textbf{No graph operations. No APOC. No GDS.}
...
\begin{factbox}[Corollary 2: Practical implications]
...
Both approaches tested on Neo4j Aura (Neo4j 5.x, Cypher~25). Test program:
...
\begin{resultbox}[\texttt{IN TRANSACTIONS} result]
...
with Cypher~25 support. They encode the 4-state test
...
\bibitem{evblog}
Halftermeyer, P. 2025.
Declarative Route Planning for EVs With Neo4j ---
Graph Traversal Grows Up.
\url{https://neo4j.com/blog/developer/declarative-route-planning-with-cypher-25/}

\bibitem{aoc}
Halftermeyer, P. 2015--2025.
Advent of Code in Pure Cypher ---
150+ puzzles solved purely in Cypher, empirical evidence of expressiveness.
\url{https://github.com/halftermeyer/adventofcode}
